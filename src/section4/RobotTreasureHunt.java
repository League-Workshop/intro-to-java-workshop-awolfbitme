...
r2d2.microMove(20);
	...
	if (robotXLocation == 710)  { JOptionPane.showMessageDialog(null, "You are nearby.");
	if (robotYLocation == 400) { JOptionPane.showMessageDialog(null,"next, you must go to the bottle. ");

		
	}
	}
	if (robotXLocation == 430) {
	if (robotYLocation == 520) { JOptionPane.showMessageDialog(null, "finally, you must go to the other")
	}
	}
