...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		System.out.println(maze.getRGB(mouseX, mouseY));
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("333832__nick121087__demonic-woman-scream.wav"));
